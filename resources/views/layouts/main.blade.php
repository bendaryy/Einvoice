...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('main/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.min.css')}}">
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
                ...
                <li class="menu-label">@lang('site.products')</li>
                ...
                <li> <a  href="{{ route('submit') }}">
                     <div class="parent-icon"><i class='bx bx-cloud-upload'></i></div>
                     <div class="menu-title">  @lang('site.Submit Products')</div>
                    </a> </li>
                ...
                <li> <a href="{{ route('rejected') }}">
                    <div class="parent-icon"><i class='bx bx-eraser'></i></div>
                     <div class="menu-title">  @lang('site.Rejected Products')</div>

                    </a>
                </li>

                <li class="menu-label">@lang('site.documents')</li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{ route('setting.index')}}"><i class="bx bx-right-arrow-alt"></i>@lang('site.apisetting')</a></li>
						<li> <a href="{{ route('company.index')}}"><i class="bx bx-right-arrow-alt"></i>@lang('site.com_setting')</a></li>
						<li> <a href="{{ route('issure.index')}}"><i class="bx bx-right-arrow-alt"></i>@lang('site.issure_file')</a></li>
				...
				<nav class="navbar navbar-expand">
						...
						<ul class="navbar-nav align-items-center">
							...
							<li class="nav-item dropdown dropdown-large">
								<a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="{{ asset('main/flags/' . LaravelLocalization::getCurrentLocale() . '.svg')}}" width="30">
                                        ...
                                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                            <li>
                                                <a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                                    <img src="{{ asset('main/flags/' . $localeCode . '.svg')}}" width="30">  {{ $properties['native'] }}
                                                </a>
                                            </li>
                                        @endforeach
                                    </ul>
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{ asset('images/' . Auth::user()->avatar)}}" class="user-img" alt="user avatar">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" href="{{ route('profile') }}"><i class="bx bx-user"></i><span> @lang('site.profile')</span></a>
							</li>
...
<script src="{{ asset('main/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.min.js')}}"></script>
<script>
